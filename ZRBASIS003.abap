...
data: it_ztrequests001 type table of ztrequests001,
      ls_ztrequests001 like it_ztrequests001.



* Inicio dos Paramentros de filtros para saida do relatório

parameters: p_jira type ztrequests001-jira,            "nº jira
            p_client type ztrequests001-cliente,      "nome do cliente
            p_produt type ztrequests001-produto,      "nome do produto
            p_reques type ztrequests001-request,      "id da request
            p_task type ztrequests001-task,           "id da tarefa"
            p_creat type ztrequests001-created_by.    "titular da tarefa"
...
types: begin of ty_request,
  jira type ztrequests001-jira,                 "nº jira
  cliente type ztrequests001-cliente,           "nome do cliente
  produto type ztrequests001-produto,           "nome do produto
  request type ztrequests001-request,           "id da request
  task type ztrequests001-task,                 "id da tarefa"
  data type ztrequests001-data,                 "dta. criação da tarefa"
  created_by type ztrequests001-created_by,     "titular da tarefa"
  keywords_en type string,
  keywords_pt type string,
  sfn_tr type ztrequests001-sfn_tr,
  ecc_tr type ztrequests001-ecc_tr,
  mobile_version type ztrequests001-mobile_version,
end of ty_request.
...
form busca_dados.
  ...
  select
  ztrequests001~jira
  ztrequests001~cliente
  ztrequests001~produto
  ztrequests001~request
  ztrequests001~task
  ztrequests001~data
  ztrequests001~created_by
  keywords_en
  keywords_pt
  sfn_tr
  ecc_tr
  mobile_version
        into table it_request from ztrequests001
